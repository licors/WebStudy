...
<ul>
	<li>
		...
		<input id="no" type="text" name="no" size="5" value="${project.no}">
	</li>
	<li>
	...
	<li>
		...
		<input id="sdate" type="text" name="startDate" placeholder="예)2018-09-18" value="${project.startDate}">
	</li>
	<li>
		<label for="edate">종료일</label>
		<input id="edate" type="text" name="endDate" placeholder="예)2018-09-18" value="${project.endDate}">
	</li>
	<li>
